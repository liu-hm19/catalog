...
require (
	...
	kusionstack.io/kusion v0.10.1-0.20240312120319-cb30c7ccb24e
	kusionstack.io/kusion-module-framework v0.0.0-20240312071743-4f1be477d829
)

require github.com/hashicorp/go-plugin v1.6.0 // indirect
